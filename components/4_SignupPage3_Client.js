...
const SignupClient3 = ({ navigation }) => {
        ...
        <View style={signupStyles.forms_container}>
          <View style={signupStyles.forms_scaffold}>
            ...
            <Text style={signupStyles.forms_scaffold_text}>
              ...
              Landjaeger ribeye andouille jerky ham. Picanha t-bone filet mignon leberkas, chicken cupim beef ribs spare ribs boudin meatloaf ball tip bacon. Andouille doner burgdoggen, ribeye turducken swine pancetta. Bacon kielbasa ham hock pancetta cow meatloaf, pork belly drumstick cupim short loin beef. Venison porchetta pork turkey biltong pork chop beef boudin burgdoggen frankfurter jerky landjaeger picanha andouille tail. Biltong beef ribs short ribs swine sirloin tenderloin turkey pork loin.{"\n\n"}
            </Text>
