...
import {  getReviews } from '../actions/consultant';
  ...
  render(){
    ...
    return(
      ...
      <View style={reviewStyles.scaffold}>
        <View>
          <FlatList
            data={this.props.singleConsultant.singleConsultant.reviews_users}
            scrollEnabled={true}
...
//         <View>
//           <FlatList
//             data={this.props.singleConsultant.userReviews}
//             scrollEnabled={true}
//             showsVerticalScrollIndicator={false}
//             keyExtractor={(item) => item.key.toString()}
//             renderItem={({ item }) => (
